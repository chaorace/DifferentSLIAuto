...
namespace DifferentSLIAuto
{
    public partial class frmPatcher : Form
    {
        ...
        private void PatcherThread()
        {
            ...
            if ((patches[2] = FindPattern(new byte[] { 0x85, 0xC0, 0x74, 0x00, 0x41, 0x0F, 0xBA, 0x2C, 0x24, 0x0F }, "xxx?xxxxxx", 0x600)) == -1 && (patches[2] = FindPattern(new byte[] { 0x85, 0xC0, 0x74, 0x00, 0x41, 0x0F, 0xBA, 0x2F, 0x0F }, "xxx?xxxxx", 0x600)) == -1)
